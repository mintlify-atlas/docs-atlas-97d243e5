        ...
        <div className="bg-white/10 dark:bg-[#1a1d27] backdrop-blur-sm rounded-2xl border border-white/20 dark:border-[#27272a] p-6">
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-white font-semibold dark:text-gray-100">0.850</span>
            </div>
            <div className="w-full bg-white/20 dark:bg-[#0f1117] rounded-full h-2">
              <div className="bg-white dark:bg-[#60A5FA] h-2 rounded-full" style={{width: '85%'}}></div>
            </div>
            <div className="flex items-center justify-between text-sm mt-4">
              <span className="text-white/80 dark:text-gray-400">Test RMSE</span>
              <span className="text-white font-semibold dark:text-gray-100">3.349</span>
            </div>
            <div className="pt-4 border-t border-white/10 dark:border-[#27272a]">
              <p className="text-xs text-white/70 dark:text-gray-400">Best Model: Decision Tree Regression</p>
            </div>
          </div>
        </div>
      </div>
