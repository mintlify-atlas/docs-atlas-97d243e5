...
Linear regression is the foundation of this project, implemented in three variants to demonstrate different modeling strategies. The **multivariate model achieves the best overall performance** with a Test R² of **0.710** and RMSE of **4.650**.

<Info>
**Best Model**: Linear Regression (Multivariate) is the top-performing model across all approaches tested in this project.
</Info>
