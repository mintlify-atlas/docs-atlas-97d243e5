...
<Accordion title="When to use RMSE">
  ...
  **Best Model in Project**: Linear Regression (Multivariate) with **Test RMSE = 4.650** ($4,650 average error)
</Accordion>
...
<Accordion title="Understanding R² Values">
  ...
  **Best Model in Project**: Linear Regression (Multivariate) with **Test R² = 0.710** (Good fit)
</Accordion>
...
From the project README (actual results):

| Model | Train R² | Test R² | Test RMSE | CV R² (mean±std) | Status |
|-------|----------|---------|-----------|------------------|--------|
| **Linear (Multivariate)** | 0.743 | **0.710** | **4.650** | 0.688 ± 0.092 | ✅ Best Model |
| **Linear (Feature Selection)** | 0.687 | 0.651 | 5.099 | 0.651 ± 0.090 | ✅ Good Fit |
...
<Note>
  **Winner**: Linear Regression with all 13 features achieves the best balance of accuracy, stability, and generalization.
</Note>
